...
import {ARTICLE_SEARCH_API, ARTICLE_FETCH_API} from '../../constants/api';

import {getCallApi, searchArticleApi} from '../../utils/utils';

/**
 *
 * @param {*} num
 */
export const loadArticleDataApi = (num,loadingType) => {
...
export const searchArticleDataApi = (searchString) => {
    return (dispatch) => {
        ...
        return searchArticleApi(ARTICLE_SEARCH_API(searchString)).then((data) => {
